...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-offers-offers-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewsOffersOffersDetailOffersDetailComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewsOffersOffersListOffersListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewsOffersOffersProfileOffersProfileComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewsOffersOffersComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<h2 class=\"mat-h2\">Offers</h2>\n\n<app-offers-list\n  [user]=\"user$ | async\"\n  [offers]=\"offers$ | async\"\n  *ngIf=\"isOffersList\"\n></app-offers-list>\n<app-offers-profile\n  [user]=\"user$ | async\"\n  *ngIf=\"!isOffersList\"\n></app-offers-profile>\n";
    /***/
  },
  ...
  /***/
  function srcAppViewsOffersOffersDetailOffersDetailComponentWrapperTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OffersDetailWrapperComponent", function () {
    ...
    var src_app_shared_states_offers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/shared/states/offers */
    "./src/app/shared/states/offers/index.ts");
    /* harmony import */


    var src_app_shared_states_user_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/shared/states/user/actions */
    "./src/app/shared/states/user/actions/index.ts");

    var OffersDetailWrapperComponent =
    /*#__PURE__*/
    function () {
      function OffersDetailWrapperComponent(store$, route) {
        var _this = this;

        _classCallCheck(this, OffersDetailWrapperComponent);

        this.store$ = store$;
        this.route = route;
        this.user$ = this.store$.select(src_app_shared_states_user__WEBPACK_IMPORTED_MODULE_4__["getProfile"]);
        this.offer$ = this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (_ref) {
          var id = _ref.id;
          return Number.parseInt(id);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (id) {
          return _this.store$.select(Object(src_app_shared_states_offers__WEBPACK_IMPORTED_MODULE_6__["getOfferByID"])(id));
        }));
      }

      _createClass(OffersDetailWrapperComponent, [{
        key: "onSubscribeOffer",
        value: function onSubscribeOffer(user) {
          this.store$.dispatch(new src_app_shared_states_user_actions__WEBPACK_IMPORTED_MODULE_7__["UpdateUser"](user));
        }
      }, {
        key: "onUnsubscribeOffer",
        value: function onUnsubscribeOffer(user) {
          this.store$.dispatch(new src_app_shared_states_user_actions__WEBPACK_IMPORTED_MODULE_7__["UpdateUser"](user));
        }
      }]);
    ...
    OffersDetailWrapperComponent.ctorParameters = function () {
      return [{
    ...
    OffersDetailWrapperComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppViewsOffersOffersDetailOffersDetailComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsOffersOffersDetailOffersDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(OffersDetailComponent, [{
        ...
        value: function subscribe() {
          var offers = [].concat(_toConsumableArray(this.user.offers), [this.offer]);
        ...
        value: function unsubscribe() {
          ...
          var offers = this.user.offers.filter(function (_offer) {
            return _offer.id !== _this2.offer.id;
          });
          var user = Object.assign({}, this.user, {
            offers: offers
          });
        ...
        value: function isSubscribe() {
          ...
          return !!(this.user && this.user.offers.find(function (_offer) {
            return _this3.offer.id === _offer.id;
          }));
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], OffersDetailComponent.prototype, "offer", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], OffersDetailComponent.prototype, "user", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], OffersDetailComponent.prototype, "subscribeOffer", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], OffersDetailComponent.prototype, "unsubscribeOffer", void 0);
    OffersDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-offers-detail',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./offers-detail.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/views/offers/offers-detail/offers-detail.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./offers-detail.component.scss */
      "./src/app/views/offers/offers-detail/offers-detail.component.scss")).default]
  ...
  /***/
  function srcAppViewsOffersOffersListOffersListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(OffersListComponent, [{
        ...
        value: function selectOffers() {
          ...
          this.offersStudy = this.offers.filter(function (offer) {
            return studiesOfUser.some(function (study) {
              return study.uid === offer.category.uid;
            });
          }).map(function (offer) {
            var offerUser = !!offersOfUser.find(function (_offerUser) {
              return _offerUser.id === offer.id;
            });
          ...
          this.offersOther = this.offers.filter(function (offer) {
            return studiesOfUser.every(function (study) {
              return study.uid !== offer.category.uid;
            });
          });
        }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], OffersListComponent.prototype, "user", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], OffersListComponent.prototype, "offers", void 0);
    OffersListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-offers-list',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./offers-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/views/offers/offers-list/offers-list.component.html")).default
    })], OffersListComponent);
    /***/
  },
  ...
  /***/
  function srcAppViewsOffersOffersProfileOffersProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], OffersProfileComponent.prototype, "user", void 0);
    OffersProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-offers-profile',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./offers-profile.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/views/offers/offers-profile/offers-profile.component.html")).default
  ...
  /***/
  function srcAppViewsOffersOffersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _offers_detail_offers_detail_component_wrapper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./offers-detail/offers-detail.component-wrapper */
    "./src/app/views/offers/offers-detail/offers-detail.component-wrapper.ts");
    ...
    OffersRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppViewsOffersOffersComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsOffersOffersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_states_offers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/shared/states/offers */
    "./src/app/shared/states/offers/index.ts");
    ...
    function () {
      function OffersComponent(route, store$) {
        ...
        this.route.data.subscribe(function (params) {
          return _this4.isOffersList = !params.my_offers;
        });
        this.user$ = this.store$.select(src_app_shared_states_user__WEBPACK_IMPORTED_MODULE_4__["getProfile"]);
    ...
    OffersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/views/offers/offers.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./offers.component.scss */
      "./src/app/views/offers/offers.component.scss")).default]
    })], OffersComponent);
    /***/
  },
  ...
  /***/
  function srcAppViewsOffersOffersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _offers_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./offers-routing.module */
    "./src/app/views/offers/offers-routing.module.ts");
    /* harmony import */


    var _offers_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./offers.component */
    "./src/app/views/offers/offers.component.ts");
    /* harmony import */


    var _offers_detail_offers_detail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./offers-detail/offers-detail.component */
    "./src/app/views/offers/offers-detail/offers-detail.component.ts");
    /* harmony import */


    var _offers_list_offers_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./offers-list/offers-list.component */
    "./src/app/views/offers/offers-list/offers-list.component.ts");
    /* harmony import */


    var _offers_profile_offers_profile_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./offers-profile/offers-profile.component */
    "./src/app/views/offers/offers-profile/offers-profile.component.ts");
    /* harmony import */


    var _offers_detail_offers_detail_component_wrapper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./offers-detail/offers-detail.component-wrapper */
    "./src/app/views/offers/offers-detail/offers-detail.component-wrapper.ts");
    ...
    OffersModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_offers_component__WEBPACK_IMPORTED_MODULE_5__["OffersComponent"], _offers_profile_offers_profile_component__WEBPACK_IMPORTED_MODULE_8__["OffersProfileComponent"], _offers_list_offers_list_component__WEBPACK_IMPORTED_MODULE_7__["OffersListComponent"], _offers_detail_offers_detail_component__WEBPACK_IMPORTED_MODULE_6__["OffersDetailComponent"], _offers_detail_offers_detail_component_wrapper__WEBPACK_IMPORTED_MODULE_9__["OffersDetailWrapperComponent"]],
...
//# sourceMappingURL=views-offers-offers-module-es5.js.map