...
function dateValidator() {
    return (control) => {
        const forbidden = !moment__WEBPACK_IMPORTED_MODULE_1__(control.value, 'DD/MM/YYYY', true).isValid();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _mock_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mock-data */ "./src/app/shared/mock-data.ts");


const COMMAND = {
    [_mock_data__WEBPACK_IMPORTED_MODULE_1__["MockData"].DOCUMENTS_TYPE[0].uid]: isValidNIF,
    [_mock_data__WEBPACK_IMPORTED_MODULE_1__["MockData"].DOCUMENTS_TYPE[1].uid]: isValidPassport,
    [_mock_data__WEBPACK_IMPORTED_MODULE_1__["MockData"].DOCUMENTS_TYPE[2].uid]: isValidOther,
...
let ProfileAccountWrapperComponent = class ProfileAccountWrapperComponent {
    constructor(store$) {
        this.store$ = store$;
...
ProfileAccountWrapperComponent.ctorParameters = () => [
...
let ProfileAccountComponent = class ProfileAccountComponent {
    ...
    save() {
        const _a = Object.assign({}, this.rForm.value), { street = '', municipe = '', province = '' } = _a, rest = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](_a, ["street", "municipe", "province"]);
        const address = {
            street,
            municipe,
            province
        };
        const user = Object.assign({}, this.user, { address }, rest);
...
ProfileAccountComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile-account.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile-student/account/profile-account.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile-account.component.scss */ "./src/app/views/profile/profile-student/account/profile-account.component.scss")).default]
    })
...
let ProfileLanguageWrapperComponent = class ProfileLanguageWrapperComponent {
    constructor(route, store$) {
        this.route = route;
        this.store$ = store$;
        this.user$ = this.store$.select(src_app_shared_states_user__WEBPACK_IMPORTED_MODULE_5__["getProfile"]);
        this.language$ = this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(({ uid: uid }) => Number.parseInt(uid)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(uid => this.store$.select(Object(src_app_shared_states_user__WEBPACK_IMPORTED_MODULE_5__["getLanguageByID"])(uid))));
    }
    onSaveLanguage(user) {
        this.store$.dispatch(new src_app_shared_states_user_actions__WEBPACK_IMPORTED_MODULE_6__["UpdateUser"](user));
    }
    onUpdateLanguage(user) {
        this.store$.dispatch(new src_app_shared_states_user_actions__WEBPACK_IMPORTED_MODULE_6__["UpdateUser"](user));
    }
};
ProfileLanguageWrapperComponent.ctorParameters = () => [
...
let ProfileLanguageComponent = class ProfileLanguageComponent {
    ...
    _update(language) {
        ...
        const user = Object.assign({}, this.user, { languages });
        this.update.emit(user);
    }
    _save(language) {
        const _language = src_app_shared_mock_data__WEBPACK_IMPORTED_MODULE_3__["MockData"].fakeIncreaseID(this.user.languages, language);
...
ProfileLanguageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile-language.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile-student/language/profile-language.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile-language.component.scss */ "./src/app/views/profile/profile-student/language/profile-language.component.scss")).default]
    })
...
let ProfileStudentComponent = class ProfileStudentComponent {
    constructor() {
        ...
        this.displayedColumnsLanguages = ['job.name', 'company.name', 'category.name', 'actions'];
        // tslint:disable-next-line: no-output-on-prefix
    ...
    deleteStudy(studyID) {
        ...
        const user = Object.assign({}, this.user, { studies });
...
ProfileStudentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile-student.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile-student/profile-student.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile-student.component.scss */ "./src/app/views/profile/profile-student/profile-student.component.scss")).default]
    })
...
let ProfileStudyWrapperComponent = class ProfileStudyWrapperComponent {
    constructor(route, store$) {
        this.route = route;
        this.store$ = store$;
        this.user$ = this.store$.select(src_app_shared_states_user__WEBPACK_IMPORTED_MODULE_4__["getProfile"]);
        this.study$ = this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(({ uid: uid }) => Number.parseInt(uid)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(uid => this.store$.select(Object(src_app_shared_states_user__WEBPACK_IMPORTED_MODULE_4__["getStudyByID"])(uid))));
    }
    onSaveStudy(user) {
        this.store$.dispatch(new src_app_shared_states_user_actions__WEBPACK_IMPORTED_MODULE_6__["UpdateUser"](user));
    }
...
ProfileStudyWrapperComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] }
];
...
let ProfileStudyComponent = class ProfileStudyComponent {
    ...
    _save(study) {
        const _study = src_app_shared_mock_data__WEBPACK_IMPORTED_MODULE_3__["MockData"].fakeIncreaseID(this.user.studies, study);
        const studies = [...this.user.studies, _study];
        const user = Object.assign({}, this.user, { studies });
        this.save.emit(user);
    }
    saveOrUpdate(_study) {
        const study = Object.assign({}, _study, { level: this.rForm.get('option').value });
...
ProfileStudyComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile-study.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile-student/study/profile-study.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile-study.component.scss */ "./src/app/views/profile/profile-student/study/profile-study.component.scss")).default]
    })
...
UniversityDegreeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./university-degree-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile-student/study/university-degree-form/university-degree-form.component.html")).default
    })
...
VocationalFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./vocational-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile-student/study/vocational-form/vocational-form.component.html")).default
    })
...
ProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/profile/profile.component.html")).default,
        changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile.component.scss */ "./src/app/views/profile/profile.component.scss")).default]
    })
], ProfileComponent);
